...
3. Put in all required data:
    ...
    - The color definition file is "colors.txt" in your `./data` folder (more info under <a href="AExamples and help/specifics.md">specifics - coloring</a>)
    - GADM shapefile is the .shp-file in your gadm folder with the according number as specified under "Column name" (more info under <a href="Examples and help/specifics.md">specifics - reigon of interest</a>)
    ...
    - Reclassification matrix is the table with information on how the tool shall reclassify (more info under <a href="Examples and help/specifics.md">specifics - reclassification</a>) - leave the default setting
...
<br/><br/>
    > If you need help with running the model, check this <a href="Examples and help/Walkthrough - model.mp4">walkthrough</a> of its execution or look under <a href="Examples and help/specifics.md">specifics</a>
