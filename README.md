...
6. It outputs one image and one Excel file at the locations you specified as output folders <br/>
    > If you need help with running the model, check this <a href="How_to_model.mp4">short video</a> where there is an example walkthrough of the model
